...
class TCL_MAP_manager:
    ...
    def _set_optimizer(self, args, model):
        ...
        optimizer_grouped_paramters = [
            {'params': [p for n, p in param_optimizer if not any(nd in n for nd in no_dacay)], 'weight_decay': args.weight_decay},
            {'params': [p for n, p in param_optimizer if any(nd in n for nd in no_decay)], 'weight_decay':0.0}
        ]

        optimizer = AdamW(optimizer_grouped_paramters, lr = args.lr, correct_bias=False)
